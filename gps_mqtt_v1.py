...
sheet_id = '1wnZMyhzFzH59oWpivvZQC7Wfx646dmQCXoiOh8j16KU'
        ...
        if msg.topic == 'loc':
            try:
                ...
                if 'lat' in payload and 'lon' in payload:
                    ...
                    time_string = current_time_cst.strftime('%Y-%m-%d %H:%M:%S')
                    values = [time_string]
                    append_values_to_column(service, sheet_id, 'time', values)
